...
app.get('/todos', function(req, res) {
	...
	// completed filter in query parameters
	...
	res.json(filteredTodos); //todos array will get converted into JSON and get send back to whoever called the API
	*/
});
...
app.post('/todos', function(req, res) {
	...
	// body.description to be trimmed value
